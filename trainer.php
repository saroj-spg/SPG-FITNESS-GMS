...
if (isset($_POST["submit"])) {
    ...
    $ins = "INSERT INTO trainer (trainer_id,name, dob,experience) VALUES ('$id','$name','$dob','$experience')";
...
<form method="POST">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" name="trainer_id" class="form-control" id="inputEmail4" placeholder="Trainer ID">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-group">
    ...
    <input type="date" name="dob" class="form-control" id="inputAddress" placeholder="Darte of Birth">
  </div>
  <div class="form-group">
